...
class CategorySignupPage extends StatefulWidget {
  const CategorySignupPage({Key? key}) : super(key: key);

  @override
  State<CategorySignupPage> createState() => _CategorySignupPageState();
}

class _CategorySignupPageState extends State<CategorySignupPage> {
  File? fileImg;
